...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel2->setText(QStringLiteral("Copyright &copy; 2013 The platinum Team"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About platinum", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>platinum</b> version", 0));
